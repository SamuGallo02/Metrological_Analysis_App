...
import sys
import os
from environment_manager import install_pytorch_environment, get_cuda_status
...
def setup_workspace():
    ...
    if os.path.exists(req_file):
        ...
        try:
            ...
            print("✔ Dipendenze generali installate correttamente.")
        except subprocess.CalledProcessError:
            print("✘ Errore nell'installazione dei requisiti standard.")
            sys.exit(1)
    else:
        print(f"⚠️ File {req_file} non trovato. Procedimento limitato a PyTorch.")
    ...
    if success:
        ...
        print("----------------------------------------------------------------------")
        print("✔ Ambiente configurato e pronto all'esecuzione delle sessioni sperimentali.")
    else:
        print("✘ Configurazione dell'accelerazione hardware non riuscita.")
