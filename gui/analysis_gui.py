...
Gestione del Training YOLO spostata in gui/training_gui.py.
...
class StereoAnalysisPage(QWidget):
    """
    Pagina di analisi metrologica stereo-fotogrammetrica (pairing rx/lx,
    rilevamento YOLO, stima stereo, tracciamento multi-frame).
    Prima era la MainWindow dell'intera applicazione; ora e' una delle
    sezioni raggiungibili dalla home, con un pulsante per tornare indietro.
    Il pulsante "TRAINING" naviga alla pagina di training invece di aprire
    una finestra modale a parte.
    """

    def __init__(self, on_home, navigate_to_training, parent: Optional[QWidget] = None) -> None:
        super().__init__(parent)
        self.on_home = on_home
        self.navigate_to_training = navigate_to_training
    ...
    def _build_ui(self) -> None:
        ...
        root_layout.addLayout(dataset_bar)
        ...
        """)
        self.btn_training.clicked.connect(self.navigate_to_training)
